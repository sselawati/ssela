...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Dosen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fk.dosen')),
                ('Mahasiswa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fk.mahasiswa')),
                ('Staf', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fk.staf')),
            ],
        ),
    ]
